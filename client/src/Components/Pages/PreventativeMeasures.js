        ...
        <div className = "App">
            <center>
                <div className = "Textbox">
                    ...
                    <p className = "text">To protect your community, you should stay home and follow what was said above. This is called isolation or quarantine. It may sound scary and lonely, but it will keep the ones you love safe and help you fight COVID-19 from infecting others.</p><br/>
                    <center><iframe width = "560" height = "315" src = "https://www.youtube.com/embed/TSkEwdzGbCA" title = "YouTube video player" frameborder = "0" allow = "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>
                </div>
                <br/><br/>
                <br/><br/><br/>
