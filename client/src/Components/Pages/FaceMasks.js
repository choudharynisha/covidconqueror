        ...
        <div className = "App">
            ...
            <div className="Textbox">
              <h2 className = "heading">Why are People Wearing Facemasks?</h2>
                ...
                <iframe width="560" height="315" src="https://www.youtube.com/embed/vGB-hxst7fo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/lt68rFG9Wq4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>  
                ...
                <p className = "text">Even with a face mask, you’ll probably notice that you can still see the kindness on their face. You can't see their mouth, but you can see the smile in their eyes. Their mask is their way of saying, “My superpower is stopping coronavirus!” When you feel comfortable, go ahead and smile back at them. </p>
            </div>
                ...
                <div className="reflection">
                    ...
                    <div class="flip-card">
                            <div class="flip-card-inner">
                                ...
                                <div class="flip-card-back"><p className = "paragraph"> Stops the spread of coronavirus and protects everyone around me</p> </div>
                            </div>
                        </div>
                        <div class="flip-card">
                            <div class="flip-card-inner">
