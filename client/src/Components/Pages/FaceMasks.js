        ...
        <div className = "App">
            ...
            <div className="Textbox">
              ...
              <br /><center><iframe width = "560" height = "315" src = "https://www.youtube.com/embed/vGB-hxst7fo" title = "YouTube video player" frameborder = "0" allow = "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                ...
                At first, you might feel a little surprised and confused with everyone around you wearing masks. That’s okay and normal. It’s just because you are not used to seeing everyone around you in masks, but you’re used to seeing someone’s whole face. But you’ll get used to their new look.<br /><br />
                Even with a face mask, you’ll probably notice that you can still see the kindness on their face. You can't see their mouth, but you can see the smile in their eyes. Their mask is their way of saying, “My superpower is stopping coronavirus!” When you feel comfortable, go ahead and smile back at them.</p><br />
            </div>
