        ...
        <div className = "App">
            ...
            <br/>
             <br/>
              ...
              <p className = "text">Children all over the world have had to change how they interact with each other because of COVID-19. In this mission, you will learn more about COVID-19, how it spreads and some of the symptoms associated with COVID-19. To start off, let's watch the video below where Tim and Moby respond to a question from young children about COVID-19.</p> 
              <center><iframe width = "560" height = "315" src = "https://www.youtube.com/embed/GoXxmzKdick?start=24&end=101" title = "YouTube video player" frameborder = "0"></iframe></center>
              ...
              <p className = "text">COVID-19 is a disease that is caused by a virus called coronavirus. The name COVID-19 stands for Coronavirus Disease of 2019.</p>
              <p className = "text">Viruses are tiny particles that can invade living cells. There are millions of types of viruses, with different behaviors, shapes, and structures. Coronaviruses are one group, named for their crown-shaped outline. To survive, a virus needs a living cell where it can make more copies itself. So it invades an organism's body and turns its cells into virus factories. When the viruses invade the body, the make the body weak and sometimes result in sickness or diseases.</p>
