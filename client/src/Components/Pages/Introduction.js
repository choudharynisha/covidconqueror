    ...
    return (
        <div className = "App">
            ...
            <div className = "Textbox">
                ...
                <center><iframe width = "100%" height = "315" src = "https://www.youtube.com/embed/GoXxmzKdick?start=24&end=101" title = "YouTube video player" frameborder = "0"></iframe></center><br /><br />
