    ...
    return (
        <div className = "App">
            ...
            <div className="Textbox">
              ...
              <p className = "text">COVID-19 is a disease that is caused by a virus called corona virus. The name COVID-19 stands for Corona Virus Disease of 2019.<br/><br/></p>
              ...
              <div class="flip-card">
                    <div class="flip-card-inner">
                        ...
                        <div class="flip-card-back"><p className = "paragraph">Virus invade the body of a healthy person and makes more copies itself therefore weakening the body and eventually making the person sick</p> </div>
                    </div>
                </div>
                <div class="flip-card">
                    <div class="flip-card-inner">
