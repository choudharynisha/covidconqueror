        ...
        <div className = "App">
            <center> 
                <div className = "Textbox">
                    ...
                    <br />
                    <center><iframe width = "100%" height = "315" src = "https://www.youtube.com/embed/fZp7BdXf25s?start=6" title = "YouTube video player" frameborder = "0" allow = "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>
                ...
                <div className = "reflection">
                    ...
                    <div class = "flip-card">
                        <div class = "flip-card-inner">
                            ...
                            <div class = "flip-card-back"><p className = "paragraph">Someone who is “at risk” for coronavirus is more likely to get very sick from coronavirus if they are exposed to coronavirus. Someone who is not “at risk” is likely to have milder symptoms like a small cold when exposed to coronavirus.</p></div>
                        </div>
                    </div>
