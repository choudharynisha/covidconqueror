        ...
        <div className = "App">
            <center> 
                <div className = "Textbox">
                    ...
                    <p className = "text">There are many factors that may put some populations at risk of getting sick from coronavirus more than others. This means that some groups are more likely to get very sick from coronavirus than others. Some factors may include age and personal medical history.<br /><br />Adults who are 65 years old or older are one of the populations at risk because when you get much older, your immune system gets weaker. When your immune system is weak, it is difficult for your body to fight diseases that come to attack it.<br /><br />People who have had cancer, diabetes, certain heart conditions, and other medical conditions are at risk of getting sick with coronavirus. Some treatments for medical conditions and illnesses weaken the immune system.</p><br />
                    <center><iframe width = "560" height = "315" src = "https://www.youtube.com/embed/fZp7BdXf25s?start=16" title = "YouTube video player" frameborder = "0" allow = "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>
                </div>
