    ...
    return (
        <div className = "App">
            ...
            <div className = "Textbox">
                ...
                The virus quickly spread to other parts of the world and more and more people got sick, first in China and then around the world. It was officially declared a pandemic in March 2020. Today, the virus has been reported in all countries in the world except 13 countries. While some regions have had more outbreaks than others, COVID-19 remains an international health problem affecting people from all over the world. To reduce the spread of the virus, entire cities have been quarantined, or closed off, to slow the disease's spread.</p><br />
            </div>
