...
class GlobalRecoveredChart extends Component {
    constructor(props){
        super(props);
        this.state = {
            countryList: [],
    ...
    handleSubmit(event){
        ...
        axios.post('/dataGlobalRecovered', {
    ...
    render() {
        return (
            <div>
                <h1>Recovered Covid Cases for {this.state.selectedCountry}</h1>
...
export default GlobalRecoveredChart;